...
function install(node) {
  ...
  const render = () => {
    ...
    ], actionsSide, true, "Load", "ds-h3-io-dropdown load");
    addDropdown("", "save-picker", dataTypeLabels, id => { void saveReferencePack(id); }, false, false, null, actionsSide, true, "Save", "ds-h3-io-dropdown save");
